package com.clubdeportivo.cazatalentos.infra.repo;
...
public class MongoEventStoreRepository implements EventStoreRepository {
    ...
    //Este es para yo poder reconstruir los eventos de un agregado
    @Override
    ...
    //Persistir un nuevo evento en esta implementacion de mongo
    @Override
